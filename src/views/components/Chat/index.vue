<template>
  <div v-if="!isAnswered" class="text-center mt-24">
    <button @click="getTarotAnswers" class="cursor-pointer bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg">
      立即占卜
    </button>
  </div>
